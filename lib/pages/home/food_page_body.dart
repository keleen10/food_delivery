    ...
    return Transform(
      ...
      child: Stack(
        ...
        decoration: BoxDecoration(
            ...
            color: index.isEven?AppColors.yellowColor:AppColors.pargColor,
            image: DecorationImage(
              fit: BoxFit.cover,
              image: NetworkImage(
          ...
          Align(
            ...
            child: Container(
                ...
                child: Container(
                  padding: EdgeInsets.only(top: Dimensions.height15, left: Dimensions.width15, right: Dimensions.width30),
